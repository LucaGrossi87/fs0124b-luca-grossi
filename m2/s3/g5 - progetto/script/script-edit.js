document.querySelector('.edit-btn').addEventListener('click', function editAmp() {
    fetch("https://striveschool-api.herokuapp.com/api/product/", {   //devo mettere l'id del prodotto, "ereditandolo" dalla card dell'index, una volta uniti gli script in un unico file, stessa cosa per eliminarlo
        method:"PUT",
        headers: {
