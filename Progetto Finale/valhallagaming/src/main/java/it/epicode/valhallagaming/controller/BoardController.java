...
//            dto.setSeatsAvailable(board.getSeatsAvailable());
...
//                bookedBoard.setSeatsAvailable(bookedBoard.getSeatsAvailable() - guests);
//                return convertToDTO(updatedBoard);
//            } else {
//                throw new EntityNotFoundException("Postazione non trovata");
//            }
...
//                board.setSeatsAvailable(board.getSeatsAvailable() - guests);
//                if (board.getSeatsAvailable()<0){
//                    throw new RuntimeException("Posti non disponibili");
//                } else if (board.getSeatsAvailable()==0) {
